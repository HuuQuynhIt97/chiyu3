...
export class OcService {
  ...
  getAllGroup(){
    return this.http.get(`${this.baseUrl}Oc/GetAllGroup104574`);
  }
  getResultByGroup(groupID , min , max) {
    return this.http.get(`${this.baseUrl}Oc/GetResultByGroup/${groupID}/${min}/${max}`, {});
  }
  addOC(oc) {
